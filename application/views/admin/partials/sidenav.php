...
=======
                    <a class="nav-link  <?= $active1 ?>" href="<?=base_url()?>">
>>>>>>> cc03b630eae34cc012527af762c695858f4ae157
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $active2 ?> " href="<?=base_url()?>admin/klinik">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link  <?= $active3 ?>" href="../pages/sign-up.html">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
