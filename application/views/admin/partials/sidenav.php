    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " data-color="info" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="<?= base_url() ?>">
                <img src="<?= base_url('public/assets/img/logo-ct-dark.png') ?>" class="navbar-brand-img h-100" alt="main_logo">
                <span class="ms-1 font-weight-bold">Sistem Informasi Lab</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse h-auto  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <!-- <li class="nav-item mt-3  ">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Pendaftaran</h6>
                </li> -->
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Klinik") ? 'active' : '' ?>" href="<?= base_url() ?>admin/klinik">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <?php } ?>
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Informasi Nilai Kritis") ? 'active' : '' ?>" href="<?=base_url("admin/InformasiNilaiKritis")?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Informasi Nilai Kritis</span>
                    </a>
                </li>
                
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Hasil Laboratorium") ? 'active' : '' ?>" href="<?=base_url("admin/HasilLaboratorium")?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="5 5 10 15" width="48" height="48">
                                <path fill="none" d="M0 0h24v24H0z" />
                                <path d="M9 16.17l-3.5-3.5 1.17-1.17 2.33 2.33L14.83 8l1.17 1.17-7 7z" />
                            </svg>
                        </div>
                        <span class="nav-link-text ms-1">Hasil Laboratorium</span>
                    </a>
                </li>
                <?php if ($this->userdata->role == "Admin"){ ?>
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Pembayaran") ? 'active' : '' ?>" href="<?=base_url("admin/pembayaran")?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Report") ? 'active' : '' ?>" href="<?=base_url("admin/report")?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Data Admin") ? 'active' : '' ?>" href="<?=base_url("admin/user")?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Data Parameter") ? 'active' : '' ?>" href="<?=base_url("admin/parameter")?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>customer-support</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Data Jenis Pemeriksaan") ? 'active' : '' ?>" href="<?=base_url("admin/jenispemeriksaan")?>">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>customer-support</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Data Jenis Pemeriksaan</span>
                    </a>
                </li>
                <?php } ?>
                ...
                <?php if ($this->userdata->role != "Admin"){ ?>
                <li class="nav-item mt-3  ">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">PEMERIKSAAN LAB KLINIK</h6>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Aktif") ? 'active' : '' ?>" href="<?= base_url() ?>admin/aktif">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>document</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <?php if ($this->userdata->role == "ATLM"){ ?>
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Verif") ? 'active' : '' ?>" href="<?= base_url() ?>admin/verif">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>document</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">VERIF HASIL</span>
                    </a>
                </li>
                <?php } ?>

                <?php if ($this->userdata->role == "Validator"){ ?>
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Validasi") ? 'active' : '' ?>" href="<?= base_url() ?>admin/validasi">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>document</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <?php if ($this->userdata->role != "Admin"){ ?>
                <li class="nav-item">
                    <a class="nav-link <?= (@$title == "Selesai") ? 'active' : '' ?>" href="<?= base_url() ?>admin/selesai">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>document</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
